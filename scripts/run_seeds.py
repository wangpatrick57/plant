...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--max-indices', default=1, help='The maximum number of times the graphlet may appear in either index')
    parser.add_argument('-s', '--sims-threshold', default=-0.95, help='The minimum (if s>0) or maximum (if s<0) mean ODV similarity value of the graphlet pair')
