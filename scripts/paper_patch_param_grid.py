...
for prox in [1, 2, 3, 4, 5, 8, 12, 15, 20, 25, 30]:
    ...
    for target_num_matching in range(1, 8):
        seeds, seed_metrics, extr_metrics = low_param_one_run(*get_gtag_run_info(gtag1, gtag2, g1_alph=True, g2_alph=True, algo=algo, lDEG=lDEG), prox=-prox, target_num_matching=-target_num_matching)
